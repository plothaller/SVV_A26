...
internal_moment_y(la, F_I, F_1z, F_2z, F_3z, x1, x2, x3, xa, theta, P)
internal_moment_z(la, F_I, F_1y, F_2y, F_3y, x1, x2, x3, xa, theta, P)
v_deflection(la, F_I, F_1z, F_2z, F_3z, x1, x2, x3, xa, theta, P, c1, c2,  E, I_zz)
w_deflection(la, F_I, F_1z, F_2z, F_3z, x1, x2, x3, xa, theta, P, c3, c4, E, I_yy)
shear_z(la, F_I, F_1z, F_2z, F_3z, x1, x2, x3, xa, theta, P)
shear_y(la, F_I, F_1y, F_2y, F_3y, x1, x2, x3, xa, theta, P)
