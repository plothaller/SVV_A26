...
print('Case 1 Region 1 max Mises:', np.around(case1_1_max_misses,decimals=4), 'GPa')
...
#print()
print('Case 1 Region 1 max S12:', np.around(case1_1_max_s12,decimals=4), 'GPa')
...
print('Case 2 Region 1 max Mises: ', np.around(case2_1_max_misses,decimals=4), 'GPa')
...
#print()
print('Case 2 Region 1 max S12: ', np.around(case2_1_max_s12,decimals=4), 'GPa')
...
print('Case 3 Region 1 max Mises: ', np.around(case3_1_max_misses,decimals=4), 'GPa')
...
#print()
print('Case 3 Region 1 max S12: ', np.around(case3_1_max_s12,decimals=4), 'GPa')
...
print('Case 1 + Case 3 Region 1 max Mises: ', np.around(case13_1_max_misses,decimals=4), 'GPa')
...
#print()
print('Case 1 + Case 3 Region 1 max S12: ', np.around(case13_1_max_s12,decimals=4), 'GPa')
